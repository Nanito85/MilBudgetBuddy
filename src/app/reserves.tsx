          ...
          <>
            ...
            <ThemedView type="backgroundElement" style={styles.card}>
              ...
              {[
                ...
                { q: 'What is a UTA?', a: 'Unit Training Assembly — a service’s term for an IDT period; the two are used interchangeably. A standard drill weekend is a "MUTA-4" (4 UTAs, 2 per day × 2 days).' },
                ...
                { q: 'Do I get paid mileage to drill?', a: 'Usually no. Your normal commute to your home unit’s drill site is not reimbursed. Some services run an IDT Travel Reimbursement Program (IDT-TRP) for members who live beyond a distance threshold from their unit (commonly cited around 100–150 miles, varies by service and funding year) — it requires prior authorization, is capped per round trip, and is NOT automatic or guaranteed even if you qualify by distance. Ask your unit admin/S1 whether your branch’s program is funded this fiscal year before counting on it.' },
              ].map((item, i) => (
