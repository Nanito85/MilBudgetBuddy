...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    military: 'The TSP C Fund IS an S&P 500 index fund. The I Fund tracks international stocks. The S Fund tracks smaller U.S. companies. You already have access to the best index funds in the world at 0.042% fees — cheaper than almost any civilian option.',
    detail:
  ...
  },
  {
    ...
    military: 'An E-2 who contributes just $100/month to TSP at age 18 will have ~$580,000 at age 60 (assuming 7% real return). The same $100/month starting at age 28 yields ~$280,000. The 10-year head start is worth $300,000 — without contributing a single extra dollar.',
    detail:
  ...
  },
  {
    ...
    actions: [
      'In TSP: invest in C Fund. It mirrors the S&P 500 at 0.042% expense ratio.',
    ...
    <ThemedView style={styles.container}>
      ...
      <ScrollView
        ...
        <ThemedText type="small" themeColor="textSecondary" style={styles.disclaimer}>
          ...
          Rates and limits reflect 2025 figures. Consult a CFP for personalized guidance.
        </ThemedText>
      </ScrollView>
    </ThemedView>
  );
