...
<div class="footer">
  ...
  All figures are estimates based on ${isCivilianOnly ? 'FY2026 OPM GS pay tables' : 'FY2026 DoD pay tables'} and self-reported data.
  ${isCivilianOnly
    ? 'This worksheet does not replace your official Earnings and Leave Statement from your payroll provider (e.g. NFC EPP).'
    : 'This worksheet does not replace an official LES from myPay.dfas.mil.'}
  Data is self-reported and not verified by ${isCivilianOnly ? 'your agency' : 'the command or DFAS'}.
</div>
</body></html>`;
