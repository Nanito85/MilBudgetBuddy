...
const styles = StyleSheet.create({
  ...
  healthEyebrow: { fontSize: 8, fontWeight: '800', letterSpacing: 0.8 },
  ...
  catOptionsDots: { fontSize: 18, letterSpacing: 2 },
  nameInput: {
    fontSize: 15,
    fontWeight: '600',
    color: Brand.primary,
  ...
  panelClose: { fontSize: 16, paddingLeft: Spacing.two },
  panelInput: {
    borderBottomWidth: 1.5,
    borderBottomColor: Brand.border,
    fontSize: 15,
  ...
  goalName: { fontSize: 13, fontWeight: '800', letterSpacing: 0.5 },
  ...
  modalTitle: { fontSize: 16, fontWeight: '800', marginBottom: Spacing.two },
  fieldLabel: {
    fontSize: 9,
    fontWeight: '800',
    letterSpacing: 1,
  ...
  modalCancelText: { fontWeight: '700', fontSize: 13 },
  modalSubmitBtn: {
    flex: 1,
    borderRadius: 4,
    paddingVertical: Spacing.two,
