...
const styles = StyleSheet.create({
  ...
  ratingChipText: { fontSize: 11, fontWeight: '700' },
  ...
  resultExact: { fontSize: 14 },
  resultRounded: { fontSize: 26, fontWeight: '900' },
  resultRight: { alignItems: 'flex-end', gap: 2 },
  resultMonthlyLabel: { fontSize: 8, fontWeight: '800', letterSpacing: 1 },
  ...
  counterBtnText: { fontSize: 18, fontWeight: '300' },
  ...
  rateMonthly: { flex: 1, fontSize: 13, fontWeight: '700' },
  rateAnnual: { fontSize: 11 },
