...
export const SCHOOL_DATA: InstallationSchoolInfo[] = [
  ...
  },
  {
    ...
    notes: 'DoDEA schools on-post serve many families; some families also use local Clarksville district schools.',
  },
  {
  ...
  },
  {
    ...
    notes: 'Fort Drum is relatively isolated — DoDEA schools serve most on-post families.',
  },
  {
