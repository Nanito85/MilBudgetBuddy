...
export const LES_FIELDS: LESField[] = [
  ...
  },
  {
    ...
    formula: 'Enlisted: $476.95/mo | Officer: $328.48/mo (FY2026)',
  ...
  },
  {
    ...
    section: 'entitlements',
    summary: '$300/month when deployed away from your family for 30+ consecutive days.',
    ...
    formula: '$300.00/month — begins on day 31 of separation',
  ...
  },
  {
    ...
    detail: 'ACIP is paid to officers who hold an aeronautical designation and have made a commitment to remain in aviation. Rates vary from $125/month to $1,000/month depending on years of aviation service, with general officers capped lower ($200-$206/month). Warrant officer aviators receive different rates. ACIP is taxable.',
  ...
  },
  {
    ...
    section: 'entitlements',
    summary: '$200/month for rated parachutists who perform a jump each month.',
    ...
    formula: '$200/month (static line, increased from $150 effective Oct 1, 2025) | $225/month (HALO/HAHO)',
...

  {
    ...
    detail: 'Social Security tax (OASDI) is 6.2% of your basic pay up to the annual wage base ($184,500 in 2026). Note: only BASIC PAY is subject to FICA — allowances (BAH, BAS) are not. If you deploy to a combat zone, FICA is deferred (not waived) and may be collected in bulk later.',
  ...
  },
  {
    ...
    section: 'deductions',
    summary: '$26/month for $500,000 of life insurance coverage (default, includes TSGLI).',
    detail: 'SGLI provides low-cost life insurance to all active duty members. The standard election is $500,000 coverage at $25/month plus $1/month for Traumatic Injury Protection (TSGLI) — $26/month total. You can reduce coverage in $50,000 increments or opt out entirely. Family SGLI (FSGLI) provides coverage for spouses and dependent children at an additional premium.',
    formula: 'Coverage ÷ $1,000 × $0.05, plus $1/month TSGLI',
    tip: 'SGLI is one of the cheapest life insurance rates available. Opting out to save $26/month is usually not worth the risk — especially if you have dependents.',
  },
  {
    id: 'dental',
    name: 'DENTAL',
...
export const RED_FLAGS = [
  ...
  },
  {
    ...
    severity: 'MEDIUM' as const,
    body: 'If you have dependents and have been deployed for more than 30 consecutive days but FSA ($300/month) is not appearing on your LES, that is an entitlement not being paid.',
  ...
  },
  {
    ...
    action: 'Switch to Roth TSP contributions on myPay while in a CZTE combat zone. You can contribute up to $72,000/year (limit increases in combat zones).',
  },
];
