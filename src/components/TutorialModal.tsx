...
const SLIDES: Slide[] = [
  {
    ...
    bullets: [
      ...
      'Local-first by default — create a free account only if you want cross-device sync',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Financial Readiness Score on Home tracks your overall financial health at a glance',
    ],
    accentColor: '#00C8A8',
  },
  {
    ...
    bullets: [
      ...
      'Savings Rate Tracker and Debt Payoff Planner keep your bigger goals on track',
    ],
  ...
  },
  {
    ...
    bullets: [
      'TLA/TLE Reimbursement — estimate lodging reimbursement during PCS moves',
      'BAH / OHA Guide — look up housing allowance by ZIP code and dependents',
      'Retirement Calculator — project your pension and BRS blended benefit',
      'Debt Payoff Planner, TSP Deep Dive, Credit Score Guide, and more',
    ],
    accentColor: '#208AEF',
  },
  {
    ...
    bullets: [
      'PCS Calculator compares BAH and total pay between your current and gaining duty stations',
      'Self-Move Pay (DITY/PPM) estimates your take-home profit for moving yourself',
      'TLA/TLE Reimbursement shows your daily lodging & meal reimbursement rates',
      'Search by base name, city, or ZIP — 195+ CONUS installations included',
    ],
    accentColor: '#C8A800',
  },
  {
    ...
    bullets: [
      ...
      'Command Mode generates a Financial Readiness Worksheet to share with your chain of command',
